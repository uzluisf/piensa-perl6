...
\section{Invocaciones de Funciones}
\label{functionchap}
\index{function!call}

Ya hemos visto algunos ejemplos de {\bf invocaciones de funciones}:
...
la diferencia entre estas dos invocaciones:
...
usar la sintaxis de la \emph{invocación de método} con la así 
llamada notación de punto. Las siguientes sentencias muestran el 
mismo resultado:
\index{invocation!method}
\index{method invocation}
\begin{verbatim}
> round 42.7;    # Sintaxis de la invocación de función
43
> 42.7.round;    # Sintaxis de la invocación de método
43
\end{verbatim}
%
